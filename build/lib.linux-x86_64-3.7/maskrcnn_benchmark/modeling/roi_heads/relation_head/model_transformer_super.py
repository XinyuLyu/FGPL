...
class TransformerContext(nn.Module):
    def __init__(self, config, obj_classes, rel_classes, in_channels):
        ...
        self.inner_dim = config.MODEL.ROI_RELATION_HEAD.CONTEXT_HIDDEN_DIM #self.cfg.MODEL.ROI_RELATION_HEAD.TRANSFORMER.INNER_DIM
    ...
    def forward(self, roi_features, proposals, logger=None):
        ...
        if self.cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL:
            ...
            obj_logits_pre = cat([proposal.get_field("predict_logits") for proposal in proposals], dim=0).detach()
            obj_embed = F.softmax(obj_logits_pre, dim=1) @ self.obj_embed1.weight
        ...
        if self.mode == 'predcls':
            ...
            obj_dists = obj_dists + obj_logits_pre
