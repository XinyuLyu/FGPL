...
model_path = '/home/lvxinyu/lib/scene-graph-benchmark/checkpoints_best/'

# model_name ='transformer_sgdet_Lr1e3_B16_It16'
model_name = 'SGDet_Transformer/'
...
sg_train_path = model_path + model_name + '/inference_train_0.01/sentence2graph_new/final_sen2graph_0.01.pytorch'
sg_test_path = model_path + model_name + '/inference/sentence2graph_new/final_sen2graph_0.01.pytorch'
...
def train(cfg, local_rank, distributed, logger):
    ...
    for epoch in range(cfg.SOLVER.MAX_ITER):
        ...
        for iteration, (fg_imgs, fg_txts, bg_imgs, bg_txts) in enumerate(train_data_loader):
            ...
            if iteration % 200 == 0:
                logger.info(
                    "iteration: {iteration} loss: {loss:.6f} lr: {lr:.6f}".format(iteration=iteration, loss=float(
