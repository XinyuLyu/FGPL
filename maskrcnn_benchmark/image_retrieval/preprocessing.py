...
detected_path = model_path+model_name+'/inference_train_0.01/VG_stanford_filtered_with_attribute_train/'
# where to save the generated annotation
output_path = model_path+model_name+'/inference_train_0.01/sentence2graph_new/final_sen2graph_0.01.pytorch'
#
