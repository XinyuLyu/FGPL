...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    #def forward(self, features, proposals, targets=None, logger=None, iteration=None, cm =None):
    def forward(self, features, proposals, targets=None, logger=None, iteration=None):
        losses = {}
        ...
        if self.cfg.MODEL.RELATION_ON:
            ...
            if self.training:
                ...
                x, detections, loss_relation, loss_relation_tuple = self.relation(features, detections, targets, logger,iteration)
