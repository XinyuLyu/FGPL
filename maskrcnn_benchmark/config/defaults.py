...
_C.MODEL.ROI_RELATION_HEAD.USE_EXTRA_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.USE_REWEIGHT_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.USE_LOGITS_REWEIGHT = False
_C.MODEL.ROI_RELATION_HEAD.USE_BCE_BATCH = False
_C.MODEL.ROI_RELATION_HEAD.MITIGATION_FACTOR_HYPER = 0.8
_C.MODEL.ROI_RELATION_HEAD.USE_MITI = False
_C.MODEL.ROI_RELATION_HEAD.MITI_TAIL = False
_C.MODEL.ROI_RELATION_HEAD.USE_COM = False
_C.MODEL.ROI_RELATION_HEAD.COM_ADJ = False
_C.MODEL.ROI_RELATION_HEAD.USE_PCM = False
_C.MODEL.ROI_RELATION_HEAD.COMPENSATION_FACTOR_HYPRT = 2.0
_C.MODEL.ROI_RELATION_HEAD.USE_CATEGORY_REWEIGHT = False
_C.MODEL.ROI_RELATION_HEAD.USE_BCE = False
_C.MODEL.ROI_RELATION_HEAD.PRED_WEIGHT_BETA = 0.99999
_C.MODEL.ROI_RELATION_HEAD.USE_CDE = False
_C.MODEL.ROI_RELATION_HEAD.USE_FOCAL = False
_C.MODEL.ROI_RELATION_HEAD.FOCAL_GAMMA = 2.0
_C.MODEL.ROI_RELATION_HEAD.USE_CONTRA_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.USE_DISTANCE_LOSS = False
_C.MODEL.ROI_RELATION_HEAD.USE_CONTRA_BCE = False
_C.MODEL.ROI_RELATION_HEAD.USE_DISTANCE_BCE = False
_C.MODEL.ROI_RELATION_HEAD.CONTRA_DISTANCE_LOSS_VALUE = 0.6
_C.MODEL.ROI_RELATION_HEAD.CONTRA_DISTANCE_LOSS_COF = 1.0
_C.MODEL.ROI_RELATION_HEAD.CANDIDATE_NUMBER = 5
