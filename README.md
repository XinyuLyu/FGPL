...
<strong>News</strong>: An extented verison of FGPL is provided in [Adaptive Fine-Grained Predicates Learning for Scene Graph Generation](https://github.com/XinyuLyu/Fine-Grained-Predicate-Learning-for-Scene-Graph-Generation)
